...
<body>
	<div class="div_button">
		<button class="button_zx" onclick="out()">QUIT</button>
	</div>
			...
			<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="demo">
				<li class="layui-nav-item layui-nav-itemed">
					...
					<dl class="layui-nav-child">
						<dd page="${pageContext.request.contextPath}/page/CLinterfacemgt.jsp">
							<a href="javascript:;" >车辆信息查询接口</a>
						</dd>
	...
	<div class="layui-tab layui-tab-card">
		<div class="layui-body layui-tab-content site-demo site-demo-body">
			<iframe id="main_iframe" src="${pageContext.request.contextPath}/page/CLinterfacemgt.jsp" style="width: 100%; height: 100%" frameborder="0"></iframe>
		</div>
	</div>
	<script type="text/javascript">
		var layer;
